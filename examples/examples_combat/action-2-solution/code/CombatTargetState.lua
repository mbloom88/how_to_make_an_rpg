...
-- Give the selection state returns a list of actors
-- that are selected.
CombatSelector =
{
...
function CombatTargetState:Create(context, params)
    ...
    local this =
    {
        ...
        mSelectType = params.targetType or CombatTargetType.One,
    ...
    if this.mDefaultSelector == nil then
        ...
        if this.mSelectType == CombatTargetType.One then
            this.mDefaultSelector = CombatSelector.WeakestEnemy
        elseif this.mSelectType == CombatTargetType.Side then
            this.mDefaultSelector = CombatSelector.SideEnemy
        elseif this.mSelectType == CombatTargetType.All then
...
function CombatTargetState:Up()
    ...
    if self.mSelectType ~= CombatTargetType.One then
        return
    end
...
function CombatTargetState:Left()
    ...
    if self.mSelectType == CombatTargetType.Side then
